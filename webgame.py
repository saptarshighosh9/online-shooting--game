...
<p style="font-size:16px"> 3.Score more than 20,000 points to win </p>
<p style="font-size:16px"> 4.Hit for a longer time will ensure more points </p>
<p style="font-size:16px"> 5.Use up down right keft arrow for moving  </p>
...
<p style="font-size:12px"> Game developed with Google App Engine,JAVAscript CANVAS element,HTML,Python 2.7 </p>
 ...
 <a href="https://github.com/saptarshighosh9">Source code is available here </a>
</div>	
	</body>
</html>
...
<img  src="http://imgs.mi9.com/uploads/3d/31/green-cartoon_422_471.jpg" width=370 height=220></a>
</div>
...
<img  src="/images/pic.png" width=370 height=220></a>
</div>
